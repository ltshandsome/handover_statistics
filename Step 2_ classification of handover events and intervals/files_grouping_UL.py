...
for dirname in all_file_dir:
    ...
    print("length of mi files = ", len(mi_files), mi_files)
    print("length of csv files = ", len(csv_files), csv_files)
    print("length of cell phone pcap files = ", len(cell_phone_pcap_files), cell_phone_pcap_files)
    print("length of UL pcap files = ", len(UL_pcap_files), UL_pcap_files)

    grouping = []
    interval = []
    
    #recording the start time and the end time of the cell info monitor file => python interval

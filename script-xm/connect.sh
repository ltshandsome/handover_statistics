...
# uplink
/sbin/iperf-3.9-m1 -c 140.112.20.183 -p [uplink port] -u -V -t 10800 -l 250 -b 200k&
# downlink
/sbin/iperf-3.9-m1 -c 140.112.20.183 -p [downlink port] -u -V -R -t 10800 -l 250 -b 200k&
# capture file
